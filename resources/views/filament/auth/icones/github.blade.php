{--
    Icone de marca do GitHub, SVG inline. Ver ADR-08 da wiki mais-provedores-sociais: Heroicons
    ...
    sozinho, sem uma cor escrita a mao nem uma regra de CSS por tema.
--}
<svg data-provedor="github" viewBox="0 0 16 16" width="18" height="18" fill="currentColor" aria-hidden="true" focusable="false">
