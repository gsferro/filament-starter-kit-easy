{{--
    View publicada do ddr/filament-captcha (vendor/ddr/filament-captcha/resources/views/drivers/turnstile.blade.php).
...
<div
  ...
  x-data="{
    ...
    renderCaptcha() {
      this.widgetId = turnstile.render(this.$refs.captcha, {
        sitekey: '{{ $getSiteKey() }}',
