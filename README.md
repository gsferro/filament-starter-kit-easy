...
| Qualidade | |
|---|---:|
| Casos de teste (`Kit` + `Tenancy`, medidos em 2026-09-23) | **2.872**, com **11.133 asserções** |
| Telas varridas em navegador real | **55** |
| Arquivos de teste | **153** em `Kit` + `Tenancy` (**180** no total) |
...
| Features especificadas (`wikis/specs/`) | **68** |
