...
(`/app/login?org=acme`, ou `/login?org=acme` com a [página única](../login-unificado/)) e o link vai
...
Com [a página única de login](../login-unificado/) ligada, o endereço do cadastro é `/cadastro`
