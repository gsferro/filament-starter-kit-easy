...
/**
 * A ficha somente-leitura de uma conta no painel app.
 *
 ...
 *
 * `ViewRecord::mount():67` chama `authorizeAccess()`, que e
 * `abort_unless(static::getResource()::canView($this->getRecord()), 403)`
 * (`ViewRecord.php:authorizeAccess:78`) — e a cadeia termina em `UserPolicy::view():17-20`, que
 * consulta `can('View:User')`. `ViewRecord::hydrate():83` repete a checagem a cada hidratacao
