...
return [
     ...
     *
     * O kit usa a versão GRATUITA do medialibrary, então esta classe não existe aqui.
     * Ficava como `TemporaryUpload::class`, o que reprova no `composer types:check`
     * (`class.notFound`) — e um `::class` de classe ausente é uma promessa que só
     * falha quando alguém liga o Pro. Como string, o valor continua correto para quem
     * instalar o Pro depois: a config é lida como nome de classe, não resolvida aqui.
     */
