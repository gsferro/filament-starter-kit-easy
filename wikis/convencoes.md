...
| Arte do login | a view `resources/views/svg/arte-do-login.blade.php`, renderizada como data URI em `app/Support/IdentidadeDoKit.php:artePadrao:82` — **não existe** `public/images/`. Para trocar, envie a arte na tela de configurações (`kit.identidade.arte_do_login`, default em `config/kit.php:arte_do_login:111`) |
